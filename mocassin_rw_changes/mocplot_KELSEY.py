...
def extra_moc_plot(flux_input, lam_input, flux_moc, lam_moc, error_flux_input, chi_sqr):
    ...
    f.write('\nlam_moc = ' + str(lam_moc))
    f.write('\nerror_flux_input = ' + str(error_flux_input))
    f.write('\nchi_sqr = ' + str(chi_sqr))
    f.close()
...
def mocplot_KELSEY(rin, rout, rho, lum, tstellar, starname, diffuse, distance, symmetric,username, outfoldername, starnum, donut, sil, carb, name_gs, filename_gs, percent_gs, totaltime,infile, nduststr, distributionFile, residual = "residual", errorcheck = "errorcheck", includePAHS = "includePAHS"):
    ...
    f.write("\nrho = " + str(rho))
    f.write("\nlum = " + str(lum))
    f.write("\ntstellar = " + str(tstellar))
    f.write("\nstarname = " + str(starname))
    f.write("\ndiffuse = " + str (diffuse))
    f.write("\ndistance = " + str(distance))
    f.write("\nsymmetric = " + str(symmetric))
    f.write("\nusername = " + str(username))
    f.write("\noutfoldername = " + str(outfoldername))
    f.write("\nstarnum = " + str(starnum))
    f.write("\ndonut = " + str(donut))
    f.write("\nsil = "  + str(sil))
    f.write("\ncarb = " + str(carb))
    f.write("\nname_gs = " + str(name_gs))
    f.write("\nfilename_gs = " + str(filename_gs))
    f.write("\nperscent_gs = " + str(percent_gs))
    f.write("\ntotal time = " + str(totaltime))
    f.write("\ninfile = " + str(infile))
    f.write("\nnduststr = " + str(nduststr))
    f.write("\ndistributionFile = " + str(distributionFile))
    numbers = []
