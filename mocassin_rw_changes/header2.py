...
__version__ = savReaderWriter.version


class Header2(Generic):
    """
    ...
    def __init__(self, savFileName, mode, refSavFileName, ioUtf8=False, ioLocale=None):
        """Constructor"""
        super(Header2, self).__init__(savFileName, ioUtf8, ioLocale)
        self.spssio = self.loadLibrary()
        self.fh = super(Header2, self).openSavFile(savFileName, mode,
                                                  refSavFileName)
